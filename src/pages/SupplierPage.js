...
export default function SupplierPage() {
  ...
  const [orderBy, setOrderBy] = useState('name'); //set orderBy date created
  ...
  return (
    <>
            ...
            <TableContainer sx={{ minWidth: 800 }}>
              <Table>
                ...
                <TableBody>
                  {suppliers &&
                    suppliers.map((row) => {
                      const { id, name, representative, tax_code, email, representative_phone, phone } = row;
      ...
      <Modal
        open={openModal}
        children={<DetailSupplier data={currentId} setOpenModal={setOpenModal} setOpenPopover={setOpen} />}
      ...
      >
        <DialogTitle id="alert-dialog-title">{'Xóa nhà cung cấp?'}</DialogTitle>
        <DialogContent>
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={() => handleDeleteItems(currentId)}>
            Đồng ý
          </Button>
        </DialogActions>
      </Dialog>
